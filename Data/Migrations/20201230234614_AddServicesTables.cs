    ...
    public partial class AddServicesTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceShoopingCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceShoopingCarts_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceShoopingCarts_ServiceTypes_ServiceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceTypeId = table.Column<int>(nullable: false),
                    SerivceName = table.Column<string>(nullable: true),
                    SerivcePrice = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceShoopingCarts_CarId",
                table: "ServiceShoopingCarts",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceShoopingCarts_ServiceTypeId",
                table: "ServiceShoopingCarts",
                column: "ServiceTypeId");
        }
